...
export const createEngineerValidation = async (req, res, next) => {
    const {employeeName, employeeDOB, employeeAddress, employeeDesignation, employeeContact, joinDate, qualification, salary} = req.body;

    if (!employeeName || !employeeDOB || !employeeAddress || !employeeDesignation || !employeeContact || !joinDate || !qualification || !salary) {
